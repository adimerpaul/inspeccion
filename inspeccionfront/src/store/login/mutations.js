...
export function auth_success(state, data){
  ...
  state.boolregistro=data.user.permisos.find(permiso=>permiso.id===1)!=undefined
  state.boolhistorial=data.user.permisos.find(permiso=>permiso.id===1)!=undefined
