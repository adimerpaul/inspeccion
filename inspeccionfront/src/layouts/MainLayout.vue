  ...
  <q-layout view="lHh Lpr lFf">
    <q-header >
      ...
      <div class="q-px-lg q-pt-xl q-mb-md">
        <div class="text-h3">Inspeccion </div>
...
<!--              <q-item-label caption>Controlar usuarios</q-item-label>-->
          ...
          <q-item to="registro"  exact clickable v-ripple v-if="$store.state.login.boolregistro">
            <q-item-section avatar>
              <q-icon name="code" />
            </q-item-section>
            <q-item-section>
...
<!--          </q-item>-->
      ...
      <q-img class="absolute-top" src="~assets/mountains.jpg" style="height: 192px">
        <div class="absolute-bottom bg-transparent">
          ...
          <div class="text-weight-bold">{{$store.state.login.user.name}}</div>
